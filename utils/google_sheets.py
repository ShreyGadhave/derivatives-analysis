...
def save_to_google_sheets(df):
    """Save calculated data + raw columns to Google Sheets."""
    try:
        ...
        # Create a copy with display columns first
        ...
        # Add raw input columns (needed for diff calculations on future uploads)
        raw_cols_to_add = []
